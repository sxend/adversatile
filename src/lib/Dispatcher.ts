...
export interface IDispatcher {
  ...
  dispatch(action: { event: "BidRequest:Consume"; data: OpenRTB.BidRequest }): void;
  dispatch(action: { event: "BidResponse:New"; data: OpenRTB.BidResponse }): void;
  dispatch(action: { event: "BidResponse:Consume"; data: OpenRTB.BidResponse }): void;
  ...
  onDispatch(event: "BidRequest:Consume", callback: (data: OpenRTB.BidRequest) => void): void;
  onDispatch(event: "BidResponse:New", callback: (data: OpenRTB.BidResponse) => void): void;
  onDispatch(event: "BidResponse:Consume", callback: (data: OpenRTB.BidResponse) => void): void;
